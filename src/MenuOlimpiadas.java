        ...
        do {
            ...
            switch (opcion) {
                ...
                case 3:
                    ...
                    ArrayList<ModeloOlimpiada>lstOlimpiada=DaoOlimpiada.listOlimpiadasByTemp(resp);
                    do {
                    ...
                    ArrayList<ModeloDeporte>lstDeporte=DaoDeporte.listSportByOlimpiada(Integer.parseInt(DaoOlimpiada.conseguirIdOlimpiada(lstOlimpiada.get(resp-1).getNombreOlimpiada(), lstOlimpiada.get(resp-1).getAnio(),lstOlimpiada.get(resp-1).getTemporada(),lstOlimpiada.get(resp-1).getCiudad())));
                    do {
                    ...
                    ArrayList<ModeloEvento>lstEventos=DaoEvento.modelosByDeporteOlimpiada(idDeporte, idOlimpiada);
                    do {
                    ...
                    System.out.println("Resumen:\nTemporada: "+temporada+"\nOlimpiada: "+DaoOlimpiada.createOlimpiadaModel(idOlimpiada)+
                            "\nDeporte: "+DaoDeporte.createDeporteModel(idDeporte)+"\nEvento: "+DaoEvento.createById(idEvento));
                    System.out.println("Deportistas:");
                    ArrayList<String>lstIdDeportistas=DaoParticipacion.getIdDeportista(idEvento);
